...
exports.tempPasswordEmail = tempPasswordEmail;
exports.googleAccountEmail = googleAccountEmail;
...
function tempPasswordEmail({ firstName, tempPassword, expiresMinutes, loginUrl, accountUrl, }) {
    const body = `
...
function googleAccountEmail({ firstName, loginUrl, }) {
    const body = `
